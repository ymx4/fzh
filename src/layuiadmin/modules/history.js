        ...
        if (obj.event === 'detail') {
          if (layui.router().search.adapter == 'm') {
            layer.open({
              ...
              content: layui.setter.baseUrl + 'diagnose/detail.html#/id=' + obj.data.ID,
              title: '就诊'
            });
          } else {
            layer.open({
        ...
        if (obj.event === 'detail') {
          if (layui.router().search.adapter == 'm') {
            layer.open({
              type: 2,
              area:['100%', $('#LAY_app_body').height() + 'px'],
              content: layui.setter.baseUrl + 'consultation/detail.html#/id=' + obj.data.ID,
              title: '会诊'
            });
          } else {
            layer.open({
        ...
        if (obj.event === 'detail') {
          if (layui.router().search.adapter == 'm') {
            layer.open({
              type: 2,
              area:['100%', $('#LAY_app_body').height() + 'px'],
              content: layui.setter.baseUrl + 'arrange/detail.html#/id=' + obj.data.ID,
              title: '随访'
            });
          } else {
            layer.open({
